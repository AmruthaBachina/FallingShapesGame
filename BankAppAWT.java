...
public class BankAppAWT extends Frame implements ActionListener {
    TextField tfAccNo, tfName, tfAmount, tfToAcc;
    TextArea ta;
    Button btnCreate, btnView, btnDeposit, btnWithdraw, btnTransfer, btnUpdate, btnClose, btnViewAll;
    Connection conn;
    ...
    BankAppAWT() {
        ...
        Label l1 = new Label("Account No:");
        l1.setBounds(50, 50, 100, 30); add(l1);
        tfAccNo = new TextField(); tfAccNo.setBounds(160, 50, 200, 30); add(tfAccNo);

        Label l2 = new Label("Name:");
        l2.setBounds(50, 100, 100, 30); add(l2);
        tfName = new TextField(); tfName.setBounds(160, 100, 200, 30); add(tfName);

        Label l3 = new Label("Amount:");
        l3.setBounds(50, 150, 100, 30); add(l3);
        tfAmount = new TextField(); tfAmount.setBounds(160, 150, 200, 30); add(tfAmount);

        Label l4 = new Label("To Account:");
        l4.setBounds(50, 200, 100, 30); add(l4);
        tfToAcc = new TextField(); tfToAcc.setBounds(160, 200, 200, 30); add(tfToAcc);

        btnCreate = new Button("Create"); btnCreate.setBounds(50, 250, 100, 30); btnCreate.addActionListener(this); add(btnCreate);
        btnView = new Button("View"); btnView.setBounds(160, 250, 100, 30); btnView.addActionListener(this); add(btnView);
        btnDeposit = new Button("Deposit"); btnDeposit.setBounds(270, 250, 100, 30); btnDeposit.addActionListener(this); add(btnDeposit);
        btnWithdraw = new Button("Withdraw"); btnWithdraw.setBounds(380, 250, 100, 30); btnWithdraw.addActionListener(this); add(btnWithdraw);
        btnTransfer = new Button("Transfer"); btnTransfer.setBounds(490, 250, 100, 30); btnTransfer.addActionListener(this); add(btnTransfer);
        btnUpdate = new Button("Update"); btnUpdate.setBounds(600, 250, 100, 30); btnUpdate.addActionListener(this); add(btnUpdate);
        btnClose = new Button("Close"); btnClose.setBounds(710, 250, 100, 30); btnClose.addActionListener(this); add(btnClose);
        btnViewAll = new Button("View All"); btnViewAll.setBounds(50, 300, 100, 30); btnViewAll.addActionListener(this); add(btnViewAll);

        ta = new TextArea(); ta.setBounds(50, 350, 800, 200); add(ta);
